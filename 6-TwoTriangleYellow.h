...
const char* fragmentShaderSource4 = "#version 460 core\n"
...
const char* fragmentShader0Source4 = "#version 460 core\n"
"out vec4 FragColor;\n" // 片段着色器只需要一个输出变量，这个变量是一个4分量向量，它表示的是最终的输出颜色，我们应该自己将其计算出来。声明输出变量可以使用out关键字，这里我们命名为FragColor。
"void main()\n"
"{\n"
...
int drawTwoTriangleYellow()
{
    ...
    glShaderSource(fragmentShaderOrange, 1, &fragmentShaderSource4, NULL);
    glCompileShader(fragmentShaderOrange);
    glShaderSource(fragmentShaderYellow, 1, &fragmentShader0Source4, NULL);
